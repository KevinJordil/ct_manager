...
const statut = computed(() => getMissionStatut(props.mission, nowStr.value))
  ...
  <div class="card">
    <div class="flex items-start justify-between gap-2">
      ...
      <div class="flex gap-1 shrink-0">
        <button @click="$emit('edit')" aria-label="Modifier la mission" title="Modifier" class="icon-btn">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
          </svg>
        </button>
        <button @click="$emit('delete')" aria-label="Supprimer la mission" title="Supprimer" class="icon-btn text-red-400 hover:text-red-600">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
